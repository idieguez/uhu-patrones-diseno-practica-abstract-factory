...
public class SeatCombustion extends Seat {
    ...
    public String toString() {
    	// return "SeatCombustion {" + "fabricante=" + fabricante + ", modelo=" + modelo + ", anoModelo=" + anoModelo + ", paisFabricante=" + paisFabricante + ", subvencion=" + subvencion + ", precioBase=" + precioBase + ", precioTrasSubvencion=" + precioTrasSubvencion + ", cambio=" + cambio + ", potencia=" + potencia + ", autonomiaMedia=" + autonomiaMedia + ", ruedaRepuesto=" + ruedaRepuesto + ", capacidadPasajeros=" + capacidadPasajeros + ", capacidadMaletero=" + capacidadMaletero + ", combustible=" + combustible + ", capacidadDeposito=" + capacidadDeposito + ", consumoMedio=" + consumoMedio + ", cilindrada=" + cilindrada + '}';
        return "SeatCombustion:     " + fabricante + " " + modelo + " " + anoModelo +
        		" [País " + paisFabricante + " · Srancel " + subvencion + "% · Precio Base " + precioBase + " € · Precio Final " + precioTrasSubvencion + "€]" +
