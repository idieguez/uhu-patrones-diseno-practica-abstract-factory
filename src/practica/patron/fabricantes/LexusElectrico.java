...
public class LexusElectrico extends Lexus {
    ...
    public String toString() {
        // return "LexusElectrico {" + "fabricante=" + fabricante + ", modelo=" + modelo + ", anoModelo=" + anoModelo + ", paisFabricante=" + paisFabricante + ", arancel=" + arancel + ", precioBase=" + precioBase + ", precioTrasArancel=" + precioTrasArancel + ", precioBaseJPY=" + precioBaseJPY + ", cambio=" + cambio + ", potencia=" + potencia + ", autonomiaMedia=" + autonomiaMedia + ", ruedaRepuesto=" + ruedaRepuesto + ", capacidadPasajeros=" + capacidadPasajeros + ", capacidadMaletero=" + capacidadMaletero + ", capacidadBateria=" + capacidadBateria + ", consumoMedio=" + consumoMedio + ", tiempoCargaTotal=" + tiempoCargaTotal + ", tiempoCarga80p=" + tiempoCarga80p + '}';
        return "LexusElectrico:     " + fabricante + " " + modelo + " " + anoModelo +
