...
public class SeatElectrico extends Seat {
    ...
    public String toString() {
    	// return "SeatElectrico {" + "fabricante=" + fabricante + ", modelo=" + modelo + ", anoModelo=" + anoModelo + ", paisFabricante=" + paisFabricante + ", subvencion=" + subvencion + ", precioBase=" + precioBase + ", precioTrasSubvencion=" + precioTrasSubvencion + ", cambio=" + cambio + ", potencia=" + potencia + ", autonomiaMedia=" + autonomiaMedia + ", ruedaRepuesto=" + ruedaRepuesto + ", capacidadPasajeros=" + capacidadPasajeros + ", capacidadMaletero=" + capacidadMaletero + ", capacidadBateria=" + capacidadBateria + ", consumoMedio=" + consumoMedio + ", tiempoCargaTotal=" + tiempoCargaTotal + ", tiempoCarga80p=" + tiempoCarga80p + '}';
        return "SeatElectrico:      " + fabricante + " " + modelo + " " + anoModelo +
